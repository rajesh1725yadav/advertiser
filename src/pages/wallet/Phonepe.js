...
export default function Phonepe ({payData, setPayData}) {
    
     const action = 'https://services.7searchppc.com/payment/phonepe';
        ...
        <Block size="lg">
            <Row className="gy-4">
                <Col sm="8">
                    ...
                    <CardHeader className="border-bottom"> PhonePe Payment </CardHeader>
                    <CardBody className="card-inner">
                        <CardTitle tag="h5">PhonePe Payment</CardTitle>
                        <CardText>
