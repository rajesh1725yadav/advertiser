...
export default function Success () {
  ...
  const prms = window.atob(trn).split('|');
            ...
            <Row className="gy-4">
                <Col sm="8">
                    ...
                    <CardBody className="card-inner text-center">
                        <Icon name="check-circle" style={{fontSize:106}} className="text-success" />
                        <CardTitle tag="h5" className="text-success">Payment Successfull!</CardTitle>
                        <CardText>
                            Congratulation! Your transaction completed successfully. 
                        </CardText>
