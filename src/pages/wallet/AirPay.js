...
export default function AirPay ({payData, setPayData}) {
    
    const action = 'https://services.7searchppc.com/payment/airpay';
        ...
        <Block size="lg">
            <Row className="gy-4">
                <Col sm="8">
                    ...
                    <CardHeader className="border-bottom"> AirPay Payment </CardHeader>
                    <CardBody className="card-inner">
                        <CardTitle tag="h5">AirPay Payment</CardTitle>
                        <CardText>
