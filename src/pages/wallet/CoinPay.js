...
export default function CoinPay ({payData, setPayData}) {
    
   const action = 'https://services.7searchppc.com/payment/bitcoin/online';
    // const action = 'http://192.168.1.14/7sapp/7searchBackend/public/payment/bitcoin/online';
    ...
    const onToken = async ( token ) => {
        ...
        // let res = await stripePayApi({
        //         token:token.id,
        //         amount:(parseFloat(payData.amt)+parseFloat(fee)),
        //         currency:'USD'
        // });
        // fetch('http://192.168.18.166/example-app/public/api/stripe/payment', {
        //   method: 'POST',
        ...
        <Block size="lg">
            <Row className="gy-4">
                <Col sm="8">
                    ...
                    <CardHeader className="border-bottom"> Coinpay Payment </CardHeader>
                    <CardBody className="card-inner">
                        <CardTitle tag="h5">Coinpay Payment</CardTitle>
                        <CardText>
