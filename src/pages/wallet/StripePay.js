...
export default function StripePay ({payData, setPayData}) {
    
   const action = 'https://services.7searchppc.com/payment/stripe';
    // const action = 'http://192.168.1.13/7sapp/7searchBackend/public/payment/stripe';
        ...
        <Block size="lg">
            <Row className="gy-4">
                <Col sm="8">
                    ...
                    <CardHeader className="border-bottom"> Stripe Payment </CardHeader>
