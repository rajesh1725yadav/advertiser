          ...
          <SimpleBar className="nk-ibx-reply nk-reply">
            <div className="nk-ibx-reply-head">
              <div>
                ...
                <span>
                  {(support && support.category == 'feedback') ? 
                      <Icon name="edit" className="text-primary" /> 
                      : (support && support.category == 'complaint') ? 
                      <Icon name="chat-fill" className="text-primary" />
                      : 
                      <Icon name="happy" className="text-primary" />} 
                      &nbsp; 
                 <span className="text-dark">{support && support.category.charAt(0).toUpperCase() + support.category.slice(1)}</span> </span>
                  <span><i>{(support && support.sub_category)? ' - '+ support.sub_category : ''}</i></span>
              </div>
            ...
            <div className="nk-ibx-reply-form nk-reply-form">
              ...
              <div className="nk-reply-form-tools">
                <ul className="nk-reply-form-actions g-1">
                  <li className="mr-2">
                    <Button color="primary" type="submit" onClick={() => sendInbox()} className="ml-2">
                      Send {}
                    </Button>
                  </li>
                  <li onClick={() =>  {
                    ...
                    /> 
                    <input type="file" id="attachmentInput"  accept="image/*, application/pdf"  style={{ display: "none" }}></input>
                  </li>
            ...
            <div className="col-md-8 offset-md-2">
              ...
              <div className="alert alert-info" >
                Your ticket <b>#{ticket}</b> has been resolved. Thanks for your patience and time, and we hope our customer support was satisfactory. 
                If there is anything else we can do for you, please don't hesitate to connect with us via mail or chat.
              </div>
              </div>
            </div>
            }
