...
import { createSocialCampaign, getCategoryList, getCountryList, getCPCInfo, uploadImage } from '../../app/api';
...
export default function SocialBarCampaign ({clkFunc}) {
        ...
        if(txt.countries != '' || conchk == true) {
          if(txt.device_type.length > 0 && txt.device_os.length > 0) {
            ...
            setLoading(true);
              ...
              const res = await createSocialCampaign(data)
          ...
          <FormGroup>
            ...
            <div className="form-control-wrap mb-3">
              ...
              <select className="form-control" name="social_ad_type" ref={register({ required: true })}
                ...
                <option value="1" key={1}>Classic</option>
                <option value="2" key={2}>Social</option> 
              </select>
            ...
            Ad title should be short, punchy, and to catch the attention of your potential customers.
              ...
              <div className='text-dark'>Remaining Characters : {txt && (20-wcount.length) }</div>
            </div>
            ...
            <input
              ...
              <div className='text-dark'>Remaining Characters : {txt && (40-wcount2.length) }</div>
            </div>
              ...
              <div className="form-control-wrap">
                      {(parseInt(txt.social_ad_type) === 1) ? <div className='row sm-social1'>
                        <div className='col-md-3 p-2' >
                          <img src={(resImg.ad1 !== '') ? resImg.ad1 : 'https://i.pinimg.com/originals/19/cf/78/19cf789a8e216dc898043489c16cec00.jpg'} className='pro-img' />
                        </div>
                      ...
                      <div className='row sm-social2'>
                        ...
                        <div className='col-md-3 p-2' >
                          <div className='img-outer float-right'>
                            <img src={(resImg.ad1 !== '') ? resImg.ad1 : 'https://i.pinimg.com/originals/19/cf/78/19cf789a8e216dc898043489c16cec00.jpg'} className='pro2-img ' />
                          </div>
                        </div>
                      </div>
                      }
