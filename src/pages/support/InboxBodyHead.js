...
import { Button, DropdownItem, DropdownMenu, DropdownToggle, Form, Modal, Spinner, UncontrolledDropdown } from "reactstrap";
      ...
      <Form onSubmit={submitForm} >
        <div className="modal-body p-4">
          ...
          <div className="nk-reply-form-editor">
            <div className="nk-reply-form-field custom-border mb-2">
              <input
                type="text"
