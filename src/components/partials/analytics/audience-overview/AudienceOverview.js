    ...
    <React.Fragment>
      <div className="card-title-group pb-3 g-2">
        <div className="card-title card-title-sm">
          <h6 className="title">Traffic Overview</h6>
        ...
        <div className="card-tools shrink-0 d-none d-sm-block">
          <ul className="nav nav-switch-s2 nav-tabs bg-white">
            ...
            <li className="nav-item">
              <a
                href="#navitem"
                className={auOverview === "day-15" ? "nav-link active" : "nav-link"}
                onClick={(e) => {
                  e.preventDefault();
                  setAuOverview("day-15");
                }}
              >
                15 D
              </a>
            ...
            <li className="nav-item">
              <a
                href="#navitem"
                className={auOverview === "month-3" ? "nav-link active" : "nav-link"}
                onClick={(e) => {
                  e.preventDefault();
